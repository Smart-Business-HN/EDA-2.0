...
{
    public class CreatePrinterConfigurationCommandValidator : AbstractValidator<CreatePrinterConfigurationCommand>
    {
        public CreatePrinterConfigurationCommandValidator()
        {
            RuleFor(x => x.Name)
