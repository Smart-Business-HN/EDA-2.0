        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InitialCorrelative = table.Column<int>(type: "int", nullable: false),
                    FinalCorrelative = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CashReceived = table.Column<double>(type: "float", nullable: true),
                    ChangeGiven = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InvoicePayments_PaymentTypes_PaymentTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SoldProducts_Discounts_DiscountId",
                        column: x => x.DiscountId,
                        principalTable: "Discounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SoldProducts_Taxes_TaxId",
                        column: x => x.TaxId,
                        principalTable: "Taxes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                table: "Customers",
                columns: new[] { "Id", "Company", "Description", "Email", "Name", "PhoneNumber" },
                values: new object[] { 1, null, null, null, "Consumidor Final", null });

            migrationBuilder.InsertData(
                table: "Discounts",
                columns: new[] { "Id", "Name", "Percentage" },
                values: new object[] { 1, "Tercera Edad", 25m });
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "LastName", "Name", "Password", "RoleId" },
                values: new object[] { 1, "User", "Admin", "WakeUpNe0", 1 });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoicePayments_PaymentTypeId",
                table: "InvoicePayments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SoldProducts_DiscountId",
                table: "SoldProducts",
                column: "DiscountId");
