...
namespace EDA.INFRAESTRUCTURE.Migrations
{
    ...
    [Migration("20260209001858_AddMultiCashRegisterAndPrinterConfig")]
    partial class AddMultiCashRegisterAndPrinterConfig
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EDA.DOMAIN.Entities.CashRegister", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EDA.DOMAIN.Entities.PrinterConfiguration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EDA.DOMAIN.Entities.CashRegister", b =>
                {
                    b.HasOne("EDA.DOMAIN.Entities.PrinterConfiguration", "PrinterConfiguration")
                        .WithMany()
            ...
            modelBuilder.Entity("EDA.DOMAIN.Entities.Invoice", b =>
                {
                    ...
                    b.HasOne("EDA.DOMAIN.Entities.CashRegister", "CashRegister")
                        .WithMany()
